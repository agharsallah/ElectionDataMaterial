      ...
      <div>
        ...
        <section className="latest-news-card " style={{ paddingTop: '10vh' }}>
          ...
          <div className=" subheaderTitle col-md-5">
            <div controlId="typeOfAssoc" className='form-group' onChange={this.handleNgoSector.bind(this)}  >
              <select className='form-control' componentClass="select" placeholder="All" defaultValue={0}>

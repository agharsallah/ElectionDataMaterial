...
class TooltipPie extends Component {
    ...
    componentWillMount() {
        ...
        let sliceColor;
    if (this.props.chosenAge=="18-35") {sliceColor="#97c6e2 "}else if (this.props.chosenAge=="36-40")
    {sliceColor="#9dd59f"}else if (this.props.chosenAge=="41-60") {sliceColor="#9dd59f"}else{sliceColor="#fcaf8a"}
        this.setState({
            options:{
                chart: {
                    type: 'bar',

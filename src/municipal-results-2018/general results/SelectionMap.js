  ...
  render() {
    ...
    return (
      <div style={{ marginTop: '3vh' }}>
        ...
        {this.state.shapeIsLoaded ? <Map maxZoom={9} center={[34.5, 9.5]} keyboard={false} scrollWheelZoom={false} zoom={7} minZoom={5} style={{ height: "95vh", width: "100%", position: "relative", backgroundColor: "white" }}>
          <TileLayer

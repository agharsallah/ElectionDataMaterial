        ...
        if (target == 'All') { this.setState({ All: 'active', Data: '', Result: '', Webradar: '', Municipal: '' }); } else
            if (target == 'Data') { this.setState({ Data: 'active', All: '', Result: '', Webradar: '', Municipal: '' }); } else
                if (target == 'Result') { this.setState({ Result: 'active', Data: '', All: '', Webradar: '', Municipal: '' }); } else
                    if (target == 'Webradar') { this.setState({ Webradar: 'active', Data: '', Result: '', All: '', Municipal: '' }); } else { this.setState({ Municipal: 'active', Data: '', Result: '', Webradar: '', All: '' }); }
    }
    render() {
        ...
        const munDataTitle4 = <Translate content='home.munDataTitle4' />//Municipal Registration Performance
        ...
        const MUN_RES_OVERVIEW = <Translate content='home.munResOverview' />//MMunicipal results Overview
...
{/* Municipal DATA part */}
                    <div id='1' className="row">
                        <h2 className="section-title" style={{ marginTop: '20vh' }}>{sectionMunicipalData}</h2></div>
...
{/* Election DATA part */}
                <div id='2' style={{marginBottom:'60px'}}></div>
                    <div  className="row">
                        <h2  className="section-title" style={{ marginTop: '20vh' }}>{sectionElectionData} </h2></div>
                        <div className='row bg-parallax'  >
                            <div className="col-md-4 hover-box">
...
{/* Election result part */}
                    <div  ></div>
                    <div id='3' className="row">
                        <h2  className="section-title" style={{ marginTop: '20vh' }}>{sectionElectionResult}</h2></div>
                        ...
                        <div className='row bg-parallax' style={{ marginBottom: '25vh' }}>
                    ...
                    <div  className="row">
                        <h2 id='4' className="section-title col-md-4" >{sectionotherViz}</h2>
                        <h2 id='5' className="section-title col-md-4" >{sectionWebradar}</h2>
                        <h2 id='6' className="section-title col-md-4" >{sectionAbout}</h2>
                    </div>
